...
ASC_W16:	mov.b	@R5,R11					;Cria uma posição auxiliar pra trabalhar
			...
			cmp.b	#48,R11					;Se ASCII for menor que 0x30(48) não serve
			jlo		invalido				;Salta direto pro retorno
			sub		#48,R11					;Se for valido, subtrai de 0x30 p/ ASCII
...
;----------------------------------------------------------------------------
			.data
; Declarar 4 caracteres ASCII (0x33, 0x36, 0x42, 0x34)
MEMO: 		.byte   '3','6','B','4'
